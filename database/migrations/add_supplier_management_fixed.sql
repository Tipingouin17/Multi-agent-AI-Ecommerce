-- ============================================================================
-- SUPPLIER MANAGEMENT SCHEMA (FIXED VERSION)
-- ============================================================================
...
-- Update timestamp triggers (drop and recreate to avoid errors)
...
DROP TRIGGER IF EXISTS supplier_products_updated_at_trigger ON supplier_products;
