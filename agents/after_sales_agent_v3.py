"""
After Sales Agent V3 - Production Ready with New Schema
Manages post-purchase customer service
"""
...
from shared.db_models import Order, Customer
...
# Create FastAPI app
app = FastAPI(title="After Sales Agent V3", version="3.0.0")
...
@app.get("/health")
def health_check():
    return {"status": "healthy", "agent": "after_sales_agent_v3", "version": "3.0.0"}
